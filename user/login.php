...
<html>
    ...
    <body style="background-image: url('../static/images/user_login.jpg');background-repeat: no-repeat;background-size: cover;background-position: center;">
        ...
        <div class="container">
            <div class="row justify-content-center mt-3">
                <div class="col col-md-4">
                    <div class="card mt-4" >
                        <div class="card-body">
                            <h3 class="text-center">Login as <b>User</b></h3>
                            <hr>
